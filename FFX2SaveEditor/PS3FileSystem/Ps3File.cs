...
namespace PS3FileSystem
{
    public class Ps3File
    {
        ...
        public bool IsEncrypted
        {
            ...
            {
                if (FileStream != null)
                    return Manager.Param_PFD.ValidEntryHash(FileStream, FileName, false);
                else
        ...
        {
            if (FileStream != null)
                return Manager.Param_PFD.Decrypt(FileStream, FileName);
            else
        ...
        {
            //if (FileStream != null)
            //    return Manager.Param_PFD.Encrypt(FileStream.ToArray(), FileName);
            //else
        ...
        {
            if (FileStream != null)
                return Manager.Param_PFD.EncryptToBytes(FileStream, FileName);
            else
